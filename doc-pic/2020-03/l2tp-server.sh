...
L2TP_NET=${VPN_L2TP_NET:-'10.103.42.0/24'}
L2TP_LOCAL=${VPN_L2TP_LOCAL:-'10.103.42.1'}
L2TP_POOL=${VPN_L2TP_POOL:-'10.103.42.10-10.103.42.250'}
XAUTH_NET=${VPN_XAUTH_NET:-'10.103.43.0/24'}
XAUTH_POOL=${VPN_XAUTH_POOL:-'10.103.43.10-10.103.43.250'}
